import { r as reactExports, R as React, j as jsxRuntimeExports, i as classNames$1 } from "./main-B7w5eCOl.js";
import { C as Controller } from "./index.esm-CiAIyUc7.js";
import { _ as _objectWithoutPropertiesLoose, a as _extends } from "./extends-2MIA_Gm_.js";
import { m as murmur2 } from "./emotion-hash.esm-D28shAk1.js";
import { r as reactDomExports } from "./navigationUtils-BZC1EMRn.js";
import { b as autoUpdate } from "./floating-ui.dom-DLwHW_QL.js";
...
function MultiSelectBox({ control, fieldName, label, placeholder, errors, register, formData, optional, maxLength, onChange: onChange2, options: options2, optionKey, values, optionText, type }) {
  ...
  if (options2) {
    options2.map((row) => {
      let selected = values && values?.length > 0 ? values.filter((x) => x.id == row.id && x.isDelete == false)?.length > 0 : false;
      if (selected) {
        selectedValues.push({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-5 multiSelectBox", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: fieldName, className: classNames$1("block text-sm font-medium text-gray-700 mb-1", error ? "text-danger" : "text-gray-400"), children: label || fieldName }),
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            StateManagedSelect$1,
            {
              ...
              className: classNames$1(
                "block w-full border-0 border-b border-transparent bg-gray-100 focus:border-darkprimary focus:ring-0 sm:text-sm",
