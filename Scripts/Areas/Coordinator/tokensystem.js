(function ($) {
  ...
  function changetoken(th, outer, isnext, ismanualcall) {
    ...
    if (th.length == 0) {
      ...
      updateactiveparticipant({ Competition: formdata.CompetitionStructureId });
      ...
      var activeParticipantId = th.attr("participantid");
      if (activeParticipantId) {
        updateactiveparticipant({ ParticipantId: activeParticipantId });
      }
  ...
  function updateactiveparticipant(formdata) {
    $.post($("#setactiveparticipantinput").val(), formdata);
  }
