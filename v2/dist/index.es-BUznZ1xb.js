import { r as reactExports, R as React, j as jsxRuntimeExports, k as React$1 } from "./main-B7w5eCOl.js";
import { c as clsx } from "./clsx-DgYk2OaC.js";
import { f as flip$1, o as offset$1, a as arrow$2, c as computePosition, i as isElement, g as getComputedStyle, b as autoUpdate } from "./floating-ui.dom-DLwHW_QL.js";
import { r as reactDomExports, j as ReactDOM } from "./navigationUtils-BZC1EMRn.js";
...
const ForwardRef = /* @__PURE__ */ reactExports.forwardRef(CalendarDateRangeIcon);
...
var CalendarContainer = function(_a2) {
  ...
  return React$1.createElement("div", { className, "aria-label": ariaLabel, role: inline ? void 0 : "dialog", "aria-modal": inline ? void 0 : "true" }, children);
};
...
var ClickOutsideWrapper = function(_a2) {
  ...
  return React$1.createElement("div", { className, style, ref: function(node) {
...
var InputTime = (
  ...
  (function(_super) {
    ...
    function InputTime2(props) {
      ...
      _this.inputRef = React$1.createRef();
      ...
      _this.renderTimeInput = function() {
        ...
        return React$1.createElement("input", { type: "time", className: "react-datepicker-time__input", placeholder: "Time", name: "time-input", ref: _this.inputRef, onClick: function() {
          var _a3;
    ...
    InputTime2.prototype.render = function() {
      return React$1.createElement(
        ...
        React$1.createElement("div", { className: "react-datepicker-time__caption" }, this.props.timeInputLabel),
        React$1.createElement(
          "div",
          { className: "react-datepicker-time__input-container" },
          React$1.createElement("div", { className: "react-datepicker-time__input" }, this.renderTimeInput())
        )
      );
    };
    return InputTime2;
      ...
      _this.render = function() {
        return (
          ...
          React$1.createElement(
            ...
            _this.getTitle() !== "" && React$1.createElement("span", { className: "overlay" }, _this.getTitle())
          )
        );
      };
      return _this;
...
var WeekNumber = (
  ...
  (function(_super) {
    ...
    WeekNumber2.prototype.render = function() {
      ...
      return React$1.createElement("div", { ref: this.weekNumberEl, className: clsx(weekNumberClasses), "aria-label": "".concat(ariaLabelPrefix, " ").concat(this.props.weekNumber), onClick: this.handleClick, onKeyDown: this.handleOnKeyDown, tabIndex: this.getTabIndex(), role: "gridcell" }, weekNumber);
    };
    return WeekNumber2;
  })(reactExports.Component)
);
var Week = (
  ...
  (function(_super) {
    ...
    function Week2() {
      ...
      _this.renderDays = function() {
        ...
        if (_this.props.showWeekNumber) {
          ...
          days.push(React$1.createElement(WeekNumber, _assign({ key: "W" }, Week2.defaultProps, _this.props, { weekNumber, isWeekDisabled: _this.isWeekDisabled(), date: startOfWeek2, onClick: onClickAction })));
        }
        return days.concat([0, 1, 2, 3, 4, 5, 6].map(function(offset2) {
          var day = addDays(startOfWeek2, offset2);
          return React$1.createElement(Day, _assign({}, Week2.defaultProps, _this.props, { ariaLabelPrefixWhenEnabled: _this.props.chooseDayAriaLabelPrefix, ariaLabelPrefixWhenDisabled: _this.props.disabledDayAriaLabelPrefix, key: day.valueOf(), day, onClick: _this.handleDayClick.bind(_this, day), onMouseEnter: _this.handleDayMouseEnter.bind(_this, day) }));
        }));
      };
    ...
    Week2.prototype.render = function() {
      ...
      return React$1.createElement("div", { className: clsx(weekNumberClasses, customWeekClassName), role: "row" }, this.renderDays());
    };
    return Week2;
  })(reactExports.Component)
);
  ...
  (function(_super) {
    ...
    function Month2() {
      ...
      _this.renderWeeks = function() {
        ...
        while (true) {
          weeks.push(React$1.createElement(Week, _assign({}, _this.props, { ariaLabelPrefix: _this.props.weekAriaLabelPrefix, key: i, day: currentWeekStart, month: getMonth(_this.props.day), onDayClick: _this.handleDayClick, onDayMouseEnter: _this.handleDayMouseEnter, selected, preSelection, showWeekNumber: _this.props.showWeekNumbers })));
      ...
      _this.renderMonths = function() {
        ...
        return monthColumns === null || monthColumns === void 0 ? void 0 : monthColumns.map(function(month, i) {
          return React$1.createElement("div", { className: "react-datepicker__month-wrapper", key: i }, month.map(function(m, j) {
            return React$1.createElement("div", { ref: _this.MONTH_REFS[m], key: j, onClick: function(event) {
      ...
      _this.renderQuarters = function() {
        ...
        return React$1.createElement("div", { className: "react-datepicker__quarter-wrapper" }, quarters.map(function(q, j) {
          return React$1.createElement("div", { key: j, ref: _this.QUARTER_REFS[j], role: "option", onClick: function(event) {
    ...
    Month2.prototype.render = function() {
      ...
      if (shouldUseListboxRole) {
        return React$1.createElement("div", { className: this.getClassNames(), onMouseLeave: !this.props.usePointerEvent ? this.handleMouseLeave : void 0, onPointerLeave: this.props.usePointerEvent ? this.handleMouseLeave : void 0, "aria-label": formattedAriaLabel, role: "listbox" }, showMonthYearPicker ? this.renderMonths() : this.renderQuarters());
      }
      return React$1.createElement(
        "div",
        { role: "table" },
        this.props.dayNamesHeader && React$1.createElement("div", { role: "rowgroup" }, this.props.dayNamesHeader),
        React$1.createElement("div", { className: this.getClassNames(), onMouseLeave: !this.props.usePointerEvent ? this.handleMouseLeave : void 0, onPointerLeave: this.props.usePointerEvent ? this.handleMouseLeave : void 0, "aria-label": formattedAriaLabel, role: "rowgroup" }, this.renderWeeks())
      );
    };
    return Month2;
  })(reactExports.Component)
...
var MonthDropdownOptions = (
  ...
  (function(_super) {
      ...
      _this.renderOptions = function() {
        ...
        return _this.props.monthNames.map(function(month, i) {
          return React$1.createElement(
            ...
            _this.isSelectedMonth(i) ? React$1.createElement("span", { className: "react-datepicker__month-option--selected" }, "✓") : "",
            month
          );
        });
      };
    ...
    MonthDropdownOptions2.prototype.render = function() {
      return React$1.createElement(ClickOutsideWrapper, { className: "react-datepicker__month-dropdown", onClickOutside: this.handleClickOutside }, this.renderOptions());
    };
...
var MonthDropdown = (
  ...
  (function(_super) {
    ...
    function MonthDropdown2() {
      ...
      _this.renderSelectOptions = function(monthNames) {
        return monthNames.map(function(m, i) {
          return React$1.createElement("option", { key: m, value: i }, m);
        });
      };
      _this.renderSelectMode = function(monthNames) {
        return React$1.createElement("select", { value: _this.props.month, className: "react-datepicker__month-select", onChange: function(e) {
      ...
      _this.renderReadView = function(visible, monthNames) {
        return React$1.createElement(
          ...
          React$1.createElement("span", { className: "react-datepicker__month-read-view--down-arrow" }),
          React$1.createElement("span", { className: "react-datepicker__month-read-view--selected-month" }, monthNames[_this.props.month])
        );
      };
      _this.renderDropdown = function(monthNames) {
        return React$1.createElement(MonthDropdownOptions, _assign({ key: "dropdown" }, _this.props, { monthNames, onChange: _this.onChange, onCancel: _this.toggleDropdown }));
      };
    ...
    MonthDropdown2.prototype.render = function() {
      ...
      return React$1.createElement("div", { className: "react-datepicker__month-dropdown-container react-datepicker__month-dropdown-container--".concat(this.props.dropdownMode) }, renderedDropdown);
    };
...
var MonthYearDropdownOptions = (
  ...
  (function(_super) {
      ...
      _this.renderOptions = function() {
        return _this.state.monthYearsList.map(function(monthYear) {
          ...
          return React$1.createElement(
            ...
            isSameMonthYear ? React$1.createElement("span", { className: "react-datepicker__month-year-option--selected" }, "✓") : "",
    ...
    MonthYearDropdownOptions2.prototype.render = function() {
      ...
      return React$1.createElement(ClickOutsideWrapper, { className: dropdownClass, onClickOutside: this.handleClickOutside }, this.renderOptions());
    };
...
var MonthYearDropdown = (
  ...
  (function(_super) {
    ...
    function MonthYearDropdown2() {
      ...
      _this.renderSelectOptions = function() {
        ...
        while (!isAfter(currDate, lastDate)) {
          ...
          options.push(React$1.createElement("option", { key: timePoint, value: timePoint }, formatDate(currDate, _this.props.dateFormat, _this.props.locale)));
          currDate = addMonths(currDate, 1);
        }
        return options;
      };
      ...
      _this.renderSelectMode = function() {
        return React$1.createElement("select", { value: getTime(getStartOfMonth(_this.props.date)), className: "react-datepicker__month-year-select", onChange: _this.onSelectChange }, _this.renderSelectOptions());
      };
      _this.renderReadView = function(visible) {
        ...
        return React$1.createElement(
          ...
          React$1.createElement("span", { className: "react-datepicker__month-year-read-view--down-arrow" }),
          React$1.createElement("span", { className: "react-datepicker__month-year-read-view--selected-month-year" }, yearMonth)
        );
      };
      _this.renderDropdown = function() {
        return React$1.createElement(MonthYearDropdownOptions, _assign({ key: "dropdown" }, _this.props, { onChange: _this.onChange, onCancel: _this.toggleDropdown }));
      };
    ...
    MonthYearDropdown2.prototype.render = function() {
      ...
      return React$1.createElement("div", { className: "react-datepicker__month-year-dropdown-container react-datepicker__month-year-dropdown-container--".concat(this.props.dropdownMode) }, renderedDropdown);
    };
    ...
    function Time2() {
      ...
      _this.renderTimes = function() {
        ...
        return times.map(function(time) {
          return React$1.createElement("li", { key: time.valueOf(), onClick: _this.handleClick.bind(_this, time), className: _this.liClasses(time), ref: function(li) {
            if (time === timeToFocus) {
              _this.centerLi = li;
            }
          }, onKeyDown: function(event) {
      ...
      _this.renderTimeCaption = function() {
        ...
        return React$1.createElement(
          ...
          React$1.createElement("div", { className: "react-datepicker-time__header" }, _this.props.timeCaption)
        );
      };
      return _this;
    }
      ...
      return React$1.createElement(
        ...
        React$1.createElement(
          ...
          React$1.createElement(
            ...
            React$1.createElement("ul", { className: "react-datepicker__time-list", ref: function(list) {
              _this.list = list;
  ...
  (function(_super) {
    ...
    Year2.prototype.render = function() {
      ...
      var _loop_1 = function(y2) {
        yearsList.push(React$1.createElement("div", { ref: this_1.YEAR_REFS[y2 - startPeriod], onClick: function(event) {
      ...
      return React$1.createElement(
        ...
        React$1.createElement("div", { className: "react-datepicker__year-wrapper", onMouseLeave: !this.props.usePointerEvent ? this.props.clearSelectingDate : void 0, onPointerLeave: this.props.usePointerEvent ? this.props.clearSelectingDate : void 0 }, yearsList)
      );
    };
    return Year2;
  })(reactExports.Component)
...
var YearDropdownOptions = (
  ...
  (function(_super) {
      ...
      _this.renderOptions = function() {
        ...
        var options = _this.state.yearsList.map(function(year) {
          return React$1.createElement(
            ...
            selectedYear === year ? React$1.createElement("span", { className: "react-datepicker__year-option--selected" }, "✓") : "",
            year
          );
        });
        ...
        if (!maxYear || !_this.state.yearsList.find(function(year) {
          ...
          options.unshift(React$1.createElement(
            "div",
            { className: "react-datepicker__year-option", key: "upcoming", onClick: _this.incrementYears },
            React$1.createElement("a", { className: "react-datepicker__navigation react-datepicker__navigation--years react-datepicker__navigation--years-upcoming" })
          ));
        }
        if (!minYear || !_this.state.yearsList.find(function(year) {
          ...
          options.push(React$1.createElement(
            ...
            React$1.createElement("a", { className: "react-datepicker__navigation react-datepicker__navigation--years react-datepicker__navigation--years-previous" })
          ));
        }
        return options;
      };
    ...
    YearDropdownOptions2.prototype.render = function() {
      ...
      return React$1.createElement(ClickOutsideWrapper, { className: dropdownClass, containerRef: this.dropdownRef, onClickOutside: this.handleClickOutside }, this.renderOptions());
    };
...
var YearDropdown = (
  ...
  (function(_super) {
    ...
    function YearDropdown2() {
      ...
      _this.renderSelectOptions = function() {
        ...
        for (var i = minYear; i <= maxYear; i++) {
          options.push(React$1.createElement("option", { key: i, value: i }, i));
        }
        return options;
      };
      _this.onSelectChange = function(event) {
      ...
      _this.renderSelectMode = function() {
        return React$1.createElement("select", { value: _this.props.year, className: "react-datepicker__year-select", onChange: _this.onSelectChange }, _this.renderSelectOptions());
      };
      _this.renderReadView = function(visible) {
        return React$1.createElement(
          "button",
          ...
          React$1.createElement("span", { className: "react-datepicker__year-read-view--down-arrow" }),
          React$1.createElement("span", { className: "react-datepicker__year-read-view--selected-year" }, _this.props.year)
        );
      };
      _this.renderDropdown = function() {
        return React$1.createElement(YearDropdownOptions, _assign({ key: "dropdown" }, _this.props, { onChange: _this.onChange, onCancel: _this.toggleDropdown }));
      };
      _this.renderScrollMode = function() {
        var dropdownVisible = _this.state.dropdownVisible;
        var result = [_this.renderReadView(!dropdownVisible)];
    ...
    YearDropdown2.prototype.render = function() {
      ...
      return React$1.createElement("div", { className: "react-datepicker__year-dropdown-container react-datepicker__year-dropdown-container--".concat(this.props.dropdownMode) }, renderedDropdown);
    };
    ...
    function Calendar2(props) {
      ...
      _this.header = function(date) {
        ...
        if (_this.props.showWeekNumbers) {
          dayNames.push(React$1.createElement(
            "div",
            { key: "W", className: "react-datepicker__day-name ".concat(disabled ? "react-datepicker__day-name--disabled" : ""), role: "columnheader" },
            React$1.createElement("span", { className: "react-datepicker__sr-only" }, "Week number"),
            React$1.createElement("span", { "aria-hidden": "true" }, _this.props.weekLabel || "#")
          ));
        }
        return dayNames.concat([0, 1, 2, 3, 4, 5, 6].map(function(offset2) {
          ...
          return React$1.createElement(
            ...
            React$1.createElement("span", { className: "react-datepicker__sr-only" }, formatDate(day, "EEEE", _this.props.locale)),
            React$1.createElement("span", { "aria-hidden": "true" }, weekDayName)
          );
        }));
      };
      ...
      _this.renderPreviousButton = function() {
        ...
        return React$1.createElement(
          ...
          React$1.createElement("span", { className: iconClasses.join(" ") }, isForYear ? previousYearButtonLabel : previousMonthButtonLabel)
        );
      };
      ...
      _this.renderNextButton = function() {
        ...
        return React$1.createElement(
          ...
          React$1.createElement("span", { className: iconClasses.join(" ") }, isForYear ? nextYearButtonLabel : nextMonthButtonLabel)
        );
      };
      _this.renderCurrentMonth = function(date) {
        ...
        return React$1.createElement("h2", { className: classes.join(" ") }, isValid(date) ? formatDate(date, _this.props.dateFormat, _this.props.locale) : "");
      };
      _this.renderYearDropdown = function(overrideHide) {
        ...
        return React$1.createElement(YearDropdown, _assign({}, Calendar2.defaultProps, _this.props, { date: _this.state.date, onChange: _this.changeYear, year: getYear(_this.state.date) }));
      };
      _this.renderMonthDropdown = function(overrideHide) {
        ...
        return React$1.createElement(MonthDropdown, _assign({}, Calendar2.defaultProps, _this.props, { month: getMonth(_this.state.date), onChange: _this.changeMonth }));
      };
      _this.renderMonthYearDropdown = function(overrideHide) {
        ...
        return React$1.createElement(MonthYearDropdown, _assign({}, Calendar2.defaultProps, _this.props, { date: _this.state.date, onChange: _this.changeMonthYear }));
      };
      ...
      _this.renderTodayButton = function() {
        ...
        return React$1.createElement("div", { className: "react-datepicker__today-button", onClick: _this.handleTodayButtonClick }, _this.props.todayButton);
      };
      _this.renderDayNamesHeader = function(monthDate) {
        return React$1.createElement("div", { className: "react-datepicker__day-names", role: "row" }, _this.header(monthDate));
      };
      ...
      _this.renderCustomHeader = function(headerArgs) {
        ...
        return React$1.createElement("div", { className: "react-datepicker__header react-datepicker__header--custom", onFocus: _this.props.onDropdownFocus }, (_b = (_a2 = _this.props).renderCustomHeader) === null || _b === void 0 ? void 0 : _b.call(_a2, _assign(_assign(_assign({}, _this.state), showYearPicker && { visibleYearsRange }), { customHeaderCount: i, monthDate, changeMonth: _this.changeMonth, changeYear: _this.changeYear, decreaseMonth: _this.decreaseMonth, increaseMonth: _this.increaseMonth, decreaseYear: _this.decreaseYear, increaseYear: _this.increaseYear, prevMonthButtonDisabled, nextMonthButtonDisabled, prevYearButtonDisabled, nextYearButtonDisabled })));
      };
      _this.renderYearHeader = function(_a2) {
        ...
        return React$1.createElement("div", { className: "react-datepicker__header react-datepicker-year-header" }, showYearPicker ? "".concat(startPeriod, " - ").concat(endPeriod) : getYear(monthDate));
      };
      ...
      _this.renderYears = function() {
        ...
        if (_this.props.showYearPicker) {
          return React$1.createElement(
            ...
            React$1.createElement(Year, _assign({}, Calendar2.defaultProps, _this.props, { selectingDate: _this.state.selectingDate, date: _this.state.date, onDayClick: _this.handleDayClick, clearSelectingDate: _this.clearSelectingDate, onYearMouseEnter: _this.handleYearMouseEnter, onYearMouseLeave: _this.handleYearMouseLeave }))
          );
        }
        return;
      };
      _this.renderTimeSection = function() {
        if (_this.props.showTimeSelect && (_this.state.monthContainer || _this.props.showTimeSelectOnly)) {
          return React$1.createElement(Time, _assign({}, Calendar2.defaultProps, _this.props, { onChange: _this.props.onTimeChange, format: _this.props.timeFormat, intervals: _this.props.timeIntervals, monthRef: _this.state.monthContainer }));
        }
        return;
      };
      _this.renderInputTimeSection = function() {
        ...
        if (_this.props.showTimeInput) {
          return React$1.createElement(InputTime, _assign({}, Calendar2.defaultProps, _this.props, { date: time, timeString, onChange: _this.props.onTimeChange }));
        }
        return;
      };
      _this.renderAriaLiveRegion = function() {
        ...
        if (!isValid(_this.state.date)) {
          return React$1.createElement("span", { role: "alert", "aria-live": "polite", className: "react-datepicker__aria-live" });
        }
        ...
        return React$1.createElement("span", { role: "alert", "aria-live": "polite", className: "react-datepicker__aria-live" }, _this.state.isRenderAriaLiveMessage && ariaLiveMessage);
      };
      _this.renderChildren = function() {
        if (_this.props.children) {
          return React$1.createElement("div", { className: "react-datepicker__children-container" }, _this.props.children);
        }
        return;
      };
...
var CalendarIcon = function(_a2) {
  ...
  if (typeof icon === "string") {
    return React$1.createElement("i", { className: "".concat(defaultClass, " ").concat(icon, " ").concat(className), "aria-hidden": "true", onClick });
  }
  if (React$1.isValidElement(icon)) {
    var iconElement_1 = icon;
    return React$1.cloneElement(iconElement_1, {
  ...
  return React$1.createElement(
    ...
    React$1.createElement("path", { d: "M96 32V64H48C21.5 64 0 85.5 0 112v48H448V112c0-26.5-21.5-48-48-48H352V32c0-17.7-14.3-32-32-32s-32 14.3-32 32V64H160V32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192H0V464c0 26.5 21.5 48 48 48H400c26.5 0 48-21.5 48-48V192z" })
  );
};
var Portal = (
  /** @class */
  ...
  (function(_super) {
    ...
    TabLoop2.prototype.render = function() {
      ...
      return React$1.createElement(
        ...
        React$1.createElement("div", { className: "react-datepicker__tab-loop__start", tabIndex: 0, onFocus: this.handleFocusStart }),
        this.props.children,
        React$1.createElement("div", { className: "react-datepicker__tab-loop__end", tabIndex: 0, onFocus: this.handleFocusEnd })
      );
    };
...
function withFloating(Component) {
  function WithFloating(props) {
    ...
    return React$1.createElement(Component, _assign({}, componentProps));
  }
...
var PopperComponent$1 = function(props) {
  ...
  if (!hidePopper) {
    ...
    popper = React$1.createElement(
      ...
      React$1.createElement(
        ...
        popperComponent,
        showArrow && React$1.createElement(FloatingArrow, { ref: popperProps.arrowRef, context: popperProps.context, fill: "currentColor", strokeWidth: 1, height: 8, width: 16, style: { transform: "translateY(-1px)" }, className: "react-datepicker__triangle" })
      )
    );
  }
  ...
  if (portalId && !hidePopper) {
    popper = React$1.createElement(Portal, { portalId, portalHost }, popper);
  }
  var wrapperClasses = clsx("react-datepicker-wrapper", wrapperClassName);
  return React$1.createElement(
    React$1.Fragment,
    null,
    React$1.createElement("div", { ref: popperProps.refs.setReference, className: wrapperClasses }, targetComponent),
    popper
  );
};
  ...
  (function(_super) {
    ...
    function DatePicker2(props) {
      ...
      _this.renderCalendar = function() {
        ...
        return React$1.createElement(Calendar, _assign({ showMonthYearDropdown: void 0, ref: function(elem) {
          _this.calendar = elem;
      ...
      _this.renderAriaLiveRegion = function() {
        ...
        return React$1.createElement("span", { role: "alert", "aria-live": "polite", className: "react-datepicker__aria-live" }, ariaLiveMessage);
      };
      _this.renderDateInput = function() {
        ...
        var customInput = _this.props.customInput || React$1.createElement("input", { type: "text" });
      ...
      _this.renderClearButton = function() {
        ...
        if (isClearable && !readOnly && (selected != null || startDate != null || endDate != null || (selectedDates === null || selectedDates === void 0 ? void 0 : selectedDates.length))) {
          return React$1.createElement("button", { type: "button", className: clsx("react-datepicker__close-icon", clearButtonClassName, { "react-datepicker__close-icon--disabled": disabled }), disabled, "aria-label": ariaLabelClose, onClick: _this.onClearClick, title: clearButtonTitle, tabIndex: -1 });
        } else {
          return null;
        }
      };
    ...
    DatePicker2.prototype.renderInputContainer = function() {
      ...
      return React$1.createElement(
        ...
        showIcon && React$1.createElement(CalendarIcon, _assign({ icon, className: clsx(calendarIconClassName, !calendarIconClassName && calendarIconClassname, open && "react-datepicker-ignore-onclickoutside") }, toggleCalendarOnIconClick ? {
    ...
    DatePicker2.prototype.render = function() {
      ...
      if (this.props.withPortal) {
        var portalContainer = this.state.open ? React$1.createElement(
          TabLoop,
          { enableTabLoop: this.props.enableTabLoop },
          React$1.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, calendar)
        ) : null;
        if (this.state.open && this.props.portalId) {
          portalContainer = React$1.createElement(Portal, _assign({ portalId: this.props.portalId }, this.props), portalContainer);
        }
        return React$1.createElement(
          "div",
          null,
      ...
      return React$1.createElement(PopperComponent, _assign({}, this.props, { className: this.props.popperClassName, hidePopper: !this.isCalendarOpen(), targetComponent: this.renderInputContainer(), popperComponent: calendar, popperOnKeyDown: this.onPopperKeyDown, showArrow: this.props.showPopperArrow }));
    };
    return DatePicker2;
  })(reactExports.Component)
);
