import{j as d,E as c}from"./sheetExport-CMiWFcwo.js";const f=async(e,{fileBase:r,pageWidthMm:i,pageHeightMm:a,marginMm:o=10,windowWidth:s=1200})=>{const p=document.createElement("iframe");p.style.cssText=`position:fixed;top:0;left:-100000px;width:${s}px;height:1700px;border:0;`,document.body.appendChild(p);try{const t=p.contentDocument;t.open(),t.write(e),t.close(),d(t.body),await new Promise(l=>setTimeout(l,400));const n=new c({unit:"mm",format:[i,a],orientation:"portrait"});await n.html(t.body,{html2canvas:{scale:2},margin:[o,o,o,o],width:i-o*2,windowWidth:t.body.scrollWidth}),n.save(`${r}.pdf`)}finally{p.remove()}},x=({title:e,css:r,body:i})=>`<!doctype html><html><head><meta charset="utf-8"><title>${e}</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@400;500;600;700&display=swap" rel="stylesheet"><style>${r}</style></head><body>${i}</body></html>`,g=e=>`
